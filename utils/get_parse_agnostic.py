...
def get_im_parse_agnostic(im_parse, pose_data, w=408, h=612):
...
class Parse_Agnostic():
    def __init__(self,data_path):
        self.data_path = data_path

    def run_agnostic(self):
        for im_name in tqdm(os.listdir(osp.join(self.data_path, 'image'))):
